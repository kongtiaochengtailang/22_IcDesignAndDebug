...
// ==============================================================
#ifndef __Conv_mac_muladd_1g8j__HH__
#define __Conv_mac_muladd_1g8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mac_muladd_1g8j) {
    ...
    SC_CTOR(Conv_mac_muladd_1g8j):  simcore_mac_0_U ("simcore_mac_0_U") {
