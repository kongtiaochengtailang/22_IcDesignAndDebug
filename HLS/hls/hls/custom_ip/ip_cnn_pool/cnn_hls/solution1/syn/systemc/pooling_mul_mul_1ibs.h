...
// ==============================================================
#ifndef __pooling_mul_mul_1ibs__HH__
#define __pooling_mul_mul_1ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pooling_mul_mul_1ibs) {
    ...
    SC_CTOR(pooling_mul_mul_1ibs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
