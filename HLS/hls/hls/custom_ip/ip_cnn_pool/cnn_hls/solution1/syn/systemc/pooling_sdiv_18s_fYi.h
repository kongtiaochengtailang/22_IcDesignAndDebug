...
// ==============================================================
#ifndef __pooling_sdiv_18s_fYi__HH__
#define __pooling_sdiv_18s_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pooling_sdiv_18s_fYi) {
    ...
    SC_CTOR(pooling_sdiv_18s_fYi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
