...
// ==============================================================
#ifndef __pooling_fcmp_32nseOg__HH__
#define __pooling_fcmp_32nseOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pooling_fcmp_32nseOg) {
    ...
    SC_CTOR(pooling_fcmp_32nseOg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
