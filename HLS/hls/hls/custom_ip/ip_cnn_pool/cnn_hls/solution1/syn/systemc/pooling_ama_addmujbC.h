...
// ==============================================================
#ifndef __pooling_ama_addmujbC__HH__
#define __pooling_ama_addmujbC__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(pooling_ama_addmujbC) {
    ...
    SC_CTOR(pooling_ama_addmujbC):  simcore_ama_0_U ("simcore_ama_0_U") {
