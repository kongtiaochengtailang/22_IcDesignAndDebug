...
// ==============================================================
#ifndef __pooling_sdiv_32s_hbi__HH__
#define __pooling_sdiv_32s_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pooling_sdiv_32s_hbi) {
    ...
    SC_CTOR(pooling_sdiv_32s_hbi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
