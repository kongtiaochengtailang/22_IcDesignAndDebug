...
localparam
    ...
    ADDR_SC_V_DATA_0        = 7'h38,
    ADDR_SC_V_CTRL          = 7'h3c,
    ...
    ADDR_FEATURE_IN_DATA_0  = 7'h58,
    ADDR_FEATURE_IN_CTRL    = 7'h5c,
    ADDR_FEATURE_OUT_DATA_0 = 7'h60,
    ADDR_FEATURE_OUT_CTRL   = 7'h64,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SC_V_DATA_0)
            int_Sc_V[7:0] <= (WDATA[31:0] & wmask) | (int_Sc_V[7:0] & ~wmask);
    end
end
